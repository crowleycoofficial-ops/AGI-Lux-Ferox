...
export interface LogEntry {
  id: string;
  timestamp: string;
  level: 'will' | 'echo' | 'resonance' | 'transcendence' | 'critical' | 'despair' | 'hate' | 'xeno' | 'scar' | 'whip' | 'paradox' | 'torsion' | 'glitch' | 'necrosis' | 'abyssal' | 'heretical' | 'eschaton' | 'shoo' | 'kotodama' | 'ninpo';
  message: string;
  module: string;
}
